...
#define VDD_CHANNEL ADC1_GPIO34_CHANNEL                                                          // Maps to GPIO34
...
enum
{
    ...
    LBL_CHECK_VDD,
    LBL_CHECK_RESETBTN,
    LBL_CHECK_PAUSE_CLOCK,
    LBL_DO_TICK_ACTION,
    LBL_COMPUTE_TICK_ACTION,
    LBL_CHECK_TUNE_ULP_TIMER,
    LBL_FN_NORM_TICK,
    LBL_FN_FWD_TICK,
    LBL_FN_REV_TICKA,
    LBL_FN_REV_TICKB,
    LBL_FN_INC_CLOCK,
    LBL_FN_DEC_CLOCK,
    LBL_FN_CALC_TIME_DIFF,
    LBL_FN_IS_DIFF_LESS_THAN,
    LBL_COMMON_RESTART_CLOCK,
    LBL_COMMON_HALT,
    LBL_COMMON_WAKE,
    LBL_NEXT = 100,
    LBL_MARKER = 2000,
    LBL_MARKER_NEXT = 1000,
};
