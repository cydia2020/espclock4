...
/////////////////////////////////////////////////////////////////////////////////
    ...
    // Normal tick
    X_RTC_GETR(VAR_TICK_DELAY, R0),
    I_MOVI(R1, NORM_COUNT_MASK),
    X_LSHIFT(R0, R1),
    X_STACK_PUSHR(R0),
    ...
    X_STACK_PUSHI(VAR_NET_SS),
    X_STACK_PUSHI(VAR_NET_MM),
    X_STACK_PUSHI(VAR_NET_HH),
    X_CALL(LBL_FN_INC_CLOCK),
    ...
    X_STACK_PUSHI(VAR_CLK_SS),
    X_STACK_PUSHI(VAR_CLK_MM),
    X_STACK_PUSHI(VAR_CLK_HH),
    X_CALL(LBL_FN_INC_CLOCK),
    X_RETURN(0),
    /////////////////////////////////////////////////////////////////////////////////
    ...
    X_RTC_GETR(VAR_CLK_MM, R0),
    X_RTC_SETR(VAR_DIFF_MM, R0),
    X_RTC_GETR(VAR_CLK_HH, R0),
